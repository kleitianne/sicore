  ...
  <section class="content">
    <div class="box-body">
      ...
      <div class="alert alert-success alert-dismissible">
        ...
        <a href="<?=base_url()?>professor/desarquivarEvento/<?=$evento->id_evento?>" style="padding: 0.5em; color: #00a65a; text-decoration: none; display: inline-block;
  font-size: 16px;" class=" pull-right"><i class=" fa  fa-inbox"></i> Desarquivar</a>
...
<br>
  ...
  font-size: 16px;"><?=$criterio->nomeCriterio?> </p>  
       ...
       <a type="submit" style="width: 760px; margin-left: auto; margin-right: auto;" class="btn-success btn btn-block btn-sucess" href="<?=base_url()?>aluno/alunosParticipantes/<?=$evento->id_evento?>">Ver alunos participantes</a>
        ...
        <a type="submit" style="width: 760px; margin-left: auto; margin-right: auto;" class="btn-success btn btn-block btn-sucess pull" href="">Ver redações corrigidas por você</a>
    </div>
