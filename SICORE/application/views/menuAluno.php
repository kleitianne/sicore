<div class="wrapper" >
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?=base_url()?>aluno/homeAluno" class="logo" style="background-color: #1a2226;">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             <i class="fa  fa-user"></i>
              <span class="hidden-xs usuario-nome_usual" name="nome"></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header usuario-foto"  style="background-color: #343a40;">
                ...
                <p class="usuario-nome_usual" name="nome">
                  
                  <small class="usuario-tipo_vinculo" name="vinculo"></small>
                </p>
              </li>
              <!-- Menu Body
              <li class="user-body">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info ">
          ...
          <small id="usuario-matricula" name="matricula"></small>
        </div>
      </div>
